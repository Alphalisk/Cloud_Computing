...
TAILSCALE_AUTH_KEY="..."  # <<< Vervang dit met de auth key, niet op github!
...
# Dit wordt in een aparte stap gedaan, omdat tailscale als WorkAround gebruikt wordt en buiten de concrete opdracht valt.